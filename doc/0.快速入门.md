...
Sdopx 可以支持类似Smarty的方式使用 也可以支持 Express.js 方式使用，
Sdopx 几乎支持Smarty 的各种使用习惯，以及扩展相应的属性，
...
Sdopx的编译是使用本人独创的链条式分支选择模式进行匹配语法结构的，并没有使用任何相应的完全正则或者是复杂的re2c模拟结构，在保证模板实现真正的解析而非单纯替换前提下又大大的改善编译效率
