...
sdopx_1.Sdopx.registerModifier('date_format', function (str, format = 'yyyy-MM-dd') {
    let date = null;
...
//左填充
sdopx_1.Sdopx.registerModifier('leftpad', function (str, len = 0, ch = ' ') {
    str = String(str);
    if (len <= str.length) {
        return str;
    }
...
sdopx_1.Sdopx.registerModifier('truncate', function (str, len = 60, etc = '') {
    str = String(str);
