...
var Source = (function () {
    ...
    Source.prototype.load = function () {
        ...
        if (content.length > 0 && sdp_1.Sdopx.Filters['pre'] && sdp_1.Sdopx.Filters['pre'] instanceof Array) {
            for (var i = 0; i < sdp_1.Sdopx.Filters['pre'].length; i++) {
                var func = sdp_1.Sdopx.Filters['pre'][i];
