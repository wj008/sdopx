...
compile_1.Compile.registerCompile('foreach', (name, args, compile) => {
...
compile_1.Compile.registerCompile('foreachelse', (name, args, compile) => {
...
compile_1.Compile.registerCompile('foreach_close', (name, compile) => {
