...
var Compile_Foreach = (function () {
    ...
    Compile_Foreach.foreach = function (name, args, compile) {
    ...
    Compile_Foreach.foreachelse = function (name, args, compile) {
    ...
    ;
    Compile_Foreach.foreach_close = function (name, compile) {
