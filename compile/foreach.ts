...
class Compile_Foreach {

    public static foreach(name, args, compile:Compile) {
    ...
    public static foreachelse(name, args, compile:Compile) {
    ...
    public static foreach_close(name, compile:Compile) {
